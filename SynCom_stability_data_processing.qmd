...
I first assigned taxnomony using 100% identity with the `assign_species()` function from dada2, but it seems like I have a errors in sequences that were not detected by the denoising algorithm so I am assigning taxonomy again with BLAST+ and 98% identity. To perform this I am using [rBLAST](https://heronoh.github.io/BLASTr/).
